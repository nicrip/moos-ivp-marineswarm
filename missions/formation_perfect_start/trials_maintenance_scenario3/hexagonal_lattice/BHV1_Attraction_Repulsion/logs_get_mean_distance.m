...
dir_name = '/home/rypkema/Workspace/moos-ivp-moossafir/missions/formation_lattice/trials_maintenance_scenario3/hexagonal_lattice/BHV1_Attraction_Repulsion/maintain/log_maintain_1/node_logs/';
...
for i = 1:size(time_series_x, 2)
    ...
    plot(time_series_x(i).Data(1), time_series_y(i).Data(1), 'x', 'MarkerSize', 10, 'MarkerEdgeColor', 'g', 'LineWidth', 2);
    count = count+1;
end
