...
dir_name = '/home/rypkema/Workspace/moos-ivp-moossafir/missions/formation_random/trials_propulsion_scenario4/square_lattice/BHV4_Assignment_Registration/propulse/log_propulse_1_10deg/node_logs/';
...
for file = files'
    ...
    time_thrust = csv(start_row:end, 19);
    time_drift = csv(start_row:end, 18);
...
plot(mean_time_thrust_ts, 'r', 'LineWidth', 2);
title('');
xlabel('Mission Time (s)');
ylabel('(Mean Distance Thrusting)/(Mean Total Distance)');
xlim([0 18000]);
