...
dir_name = '/home/rypkema/Workspace/moos-ivp-moossafir/missions/formation_random/trials_propulsion_scenario4/square_lattice/BHV4_Assignment_Registration/propulse/log_propulse_2/node_logs/';
...
mean_energy = mean_energy_ts.Data;
efficiency = dist_travelled./mean_energy;

figure
plot(efficiency, 'LineWidth', 1.5);
xlabel('Mission Time (s)');
ylabel('Travel Efficiency (m/Wh)');
xlim([0 18000]);
figure
plot(dist_travelled, mean_energy, 'LineWidth', 1.5);
xlabel('Swarm Centroid Distance Travelled (m)');
