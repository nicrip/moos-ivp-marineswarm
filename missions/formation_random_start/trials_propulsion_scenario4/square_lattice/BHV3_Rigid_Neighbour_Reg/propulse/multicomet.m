...
for i=1:n
    ...
    head(i) = line('parent',ax,'color',co(1,:),'marker','o','MarkerFaceColor',co(1,:),'MarkerSize',9,'erase','xor', ...
        'xdata',x(1,i),'ydata',y(1,i));
    body(i) = line('parent',ax,'color',co(i,:),'linestyle','-','LineWidth',2,'erase','none', ...
        'xdata',[],'ydata',[]);
end
