...
nsplug meta_vehicle.moos targ_$VNAME10.moos -f WARP=$TIME_WARP \
    VNAME=$VNAME10      START_POS=$START_POS10                  \
    VPORT="9010"       SHARE_LISTEN="9310"                    \
    VTYPE="kayak"      SHORE_LISTEN=$SHORE_LISTEN	MODEM_ID=$MODEM_ID10
...
nsplug meta_vehicle.bhv targ_$VNAME10.bhv -f VNAME=$VNAME10     \
