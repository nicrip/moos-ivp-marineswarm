...
protected: // Local Utility functions
  ...
  void          assignmentScores(mat nodes, int angle_delta, std::vector<mat> &scores_form, std::vector< std::vector< std::pair<int, int> > > &assignments, Col<int> &min_costs);
  void          optimalAssignment(std::vector<mat> &scores_form, std::vector< std::vector< std::pair<int, int> > > &assignments, Col<int> &min_costs, mat &optimal_formation);
  int**         matToArrayArray(Col<int> &m, int rows, int cols);
