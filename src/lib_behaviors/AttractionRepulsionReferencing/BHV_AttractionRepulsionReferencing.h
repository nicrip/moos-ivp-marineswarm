...
/*    NAME: Nick Rypkema                                    */
/*    ORGN: MIT                                             */
/*    FILE: BHV_AttractionRepulsionReferencing.h            */
/*    DATE:                                                 */
/************************************************************/

#ifndef AttractionRepulsionReferencing_HEADER
#define AttractionRepulsionReferencing_HEADER
...
class BHV_AttractionRepulsionReferencing : public BHV_DriftingForce, public BHV_AcousticPingPlanner {
public:
  BHV_AttractionRepulsionReferencing(IvPDomain);
  ~BHV_AttractionRepulsionReferencing() {};
...
extern "C" {
  ...
  {return new BHV_AttractionRepulsionReferencing(domain);}
}
#endif
