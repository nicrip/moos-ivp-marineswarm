...
void showSynopsis()
{
  ...
  blk("  depth objectives and output on rudder, thrust and pitch_thrust fed");
...
void showHelpAndExit()
{
  blk("                                                           ");
  blu("========================================================== ");
  blu("Usage: pFolagaPID_CGG file.moos [OPTIONS]                      ");
  blu("========================================================== ");
  blk("                                                           ");
  showSynopsis();
  blk("                                                           ");
  ...
  blk("      Launch pFolagaPID_CGG with the given process name rather ");
  ...
  mag("  --version,-v                                             ");
  blk("      Display release version of pFolagaPID_CGG.               ");
  blk("                                                           ");
...
void showExampleConfigAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("pFolagaPID_CGG Example MOOS Configuration                           ");
  blu("=============================================================== ");
...
{
  showReleaseInfo("pFolagaPID_CGG", "gpl");
  exit(0);
}
